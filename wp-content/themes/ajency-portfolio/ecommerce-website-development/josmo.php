      ...
      <div class="headerfix ">
        <div class="bread-crumb d-flex flex-wrap">
          ...
          <div class="bread-crumb__menu levelTwo">
            ...
            <h1><a href="<?php echo get_site_url(); ?>/ecommerce-website-development/josmo/" class="actionable text-link h1 is-active text-black normal-font">Josmo</a></h1>
...
<div class="container p5">
  <div class="row">
    <div class="col  offset-xl-2 col-xl-8 col12">
     <p class="body-text">
     Josmo offers a rare combination of a design studio and an expansive furniture foundry working in tandem under the same roof. We developed the website in 2020 and continue to offer support.
     </p>
    </div>
  </div>
</div>
    ...
    <div class="col  offset-xl-2 col-xl-5 col-12 my-auto">
     ...
     <div class="col-12  col-md-3 mt-4 mt-md-0">
      <div class="text-overlay d-flex">
          <h4 class="card-title m-auto h1 align-item-center text-center font-weight-bold" style="color:#909090;">Every form submission gets added to a Google sheet.</h4>
...
<div class="container p5">
  <div class="row">
    <div class="col-12 col-md-3  offset-xl-2 mt-4 mt-md-0">
      ...
      <div class="text-overlay d-flex">
          <h4 class="card-title m-auto h1 align-item-center text-center font-weight-bold" style="color:#909090;">Stock Availability Inquiry</h4>
      </div>
    </div>
