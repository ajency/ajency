      ...
      <div class="headerfix ">
        <div class="bread-crumb d-flex flex-wrap">
          ...
          <div class="bread-crumb__menu levelTwo">
            ...
            <h1><a href="<?php echo get_site_url(); ?>/ecommerce-website-development/gritzo/" class="is-active text-black actionable text-link h1 normal-font">Gritzo</a></h1>
...
<div class="container p5">
  <div class="row">
    <div class="col  offset-xl-2 col-xl-8 col12">
     <p class="body-text">
      Gritzo creates only the best nutrition products for kids, without compromising on quality, safety, integrity and quantity of ingredients, or taste.
     </p>
    </div>
  </div>
</div>
...
<div class="container p5  pb-0 pt-0">
  <div class="row">
    <div class="col  offset-xl-2 col-xl-8 col12">
          ...
          <h1 class="card-title m-auto w-75 align-item-center text-center font-weight-bold" style="color:#240a70;">Gritzo - Kids Protein Drinks & Healthy Protein Shakes</h1>
...
<div class="container p5">
  <div class="row">
    <div class="col  offset-xl-2 col-xl-8 col12">
          ...
          data-srcset=" <?php echo get_template_directory_uri(); ?>/img/portfolio/gritzo/single-product-page.jpg  1676w, <?php echo get_template_directory_uri(); ?>/img/portfolio/gritzo/single-product-page.jpg 1200w, <?php echo get_template_directory_uri(); ?>/img/portfolio/gritzo/single-product-page.jpg  700w"
          data-sizes="(min-width: 768px) 60vw,  100vw" class="img-fluid lazyload blur-up">
      </div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col  offset-xl-2 col-xl-5 col-12 my-auto">
     ...
     <div class="col-12  col-md-3 mt-4 mt-md-0">
      <div class="text-overlay d-flex">
          <h4 class="card-title m-auto h1 align-item-center text-center font-weight-bold" style="color:#909090;">Sticky button and form for lead capture</h4>
