              ...
              <div class="card-wrapper" data-target="card1">
                <div class="logocard pf-healthkart">
                  <!-- <img src="<?php echo get_template_directory_uri(); ?>/img/temp/logo-hk.png"
                   ...
                   <img src="<?php echo get_template_directory_uri(); ?>/img/portfolio_assets/healthkart/healthkart-logo.png" alt="healthkart logo" class="prj-logo">
                </div>
                <div class="expanded">
									<!-- Healthkart -->
            ...
            <div class="col-6 card-trigger">
              <div class="card-wrapper bg-orange" data-target="card2">
                <div class="logocard pf-commonfloor">
                   ...
                   data-sizes="100vw"
                   class="d-block m-auto lazyload blur-up"> -->
                   <img src="<?php echo get_template_directory_uri(); ?>/img/portfolio_assets/commonfloor/commonfloor-logo.png" alt="commonfloor logo" class="prj-logo">
                </div>
                <div class="expanded">
                  <!-- Commonfloor -->
                  <div class="prj-container">
            ...
            <div class="col-6 card-trigger">
              <div class="card-wrapper bg-blue" data-target="card3">
                <div class="logocard pf-growthinvest">
                   <img src="<?php echo get_template_directory_uri(); ?>/img/portfolio_assets/growthinvest/growthinvest-logo.png" alt="growthinvest logo" class="prj-logo">
                </div>
                <div class="expanded">
                  <!-- Growthinvest -->
                  <div class="prj-container">
            ...
            <div class="col-6 card-trigger">
              <div class="card-wrapper bg-cream bg-cream-mob" data-target="card4">
                <div class="logocard pf-weddingz">
                     <img src="<?php echo get_template_directory_uri(); ?>/img/portfolio_assets/weddingz/weddingz-logo.png" alt="Weddingz logo" class="prj-logo">
                </div>
                <div class="expanded">
                  <!-- Weddingz -->
                  <div class="prj-container">
              ...
              <div class="card-wrapper bg-lightwhite" data-target="card5">
                <div class="logocard pf-mylan">
                    <!-- <img src="<?php echo get_template_directory_uri(); ?>/img/temp/logo-mylan.png"
                       data-sizes="100vw"
                       class="d-block m-auto lazyload blur-up"> -->
                       <img src="<?php echo get_template_directory_uri(); ?>/img/portfolio_assets/mylan/mylan-logo.png" alt="mylan logo" class="prj-logo">
                </div>
                <div class="expanded">
                  <!-- Mylan -->
                  <div class="prj-container">
