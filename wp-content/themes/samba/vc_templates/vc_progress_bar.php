...
foreach($graph_lines_data as $line) {
    ...
    if ($my_color!="") {
        $unit = ($units!='') ? ' <div class="small_squared regular_font" style="color: '.$my_color.';">' .  $line['value'] . $units . '</div> ' : '';
    }
    else
    {
    ...
    {
        $output .= '<div class="vc_single_bar gusto_no_info'.$bgcolor.'">';
    }
    $output .= '<small class="vc_label header_font">'. $unit . $line['label'] .'</small>';
