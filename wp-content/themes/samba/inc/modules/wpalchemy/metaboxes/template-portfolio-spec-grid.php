...
(
	...
	'template' => get_template_directory() . '/inc/modules/wpalchemy/metaboxes/template-portfolio-meta-grid.php',
	'include_template' => array(
		'template_portfolio_var-grid.php') // use an array for multiple items
));
/* eof */