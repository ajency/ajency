<?php 
  ...
  if (isset($prk_samba_frontend_options['woo_sidebar_display']) && isset($prk_samba_frontend_options['woo_sidebar_display']))
    $show_sidebar=$prk_samba_frontend_options['woo_sidebar_display'];
  else
    $show_sidebar="yes";
