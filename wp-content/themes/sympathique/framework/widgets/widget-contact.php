...
class dt_fancy_contact extends WP_Widget {
    ...
    function dt_fancy_contact() {
        parent::__construct(false, $name = 'Sympathique - Fancy Contact');
    }
                ...
                if ( $title )
					...
					?>								
						<ul id="contact-widget">
							<li class="address"><?php _e('Address: ', 'delicious'); echo $address; ?></li>		
							<li class="phone"><?php _e('Phone: ', 'delicious'); echo $phone; ?></li>		
							<li class="email"><?php _e('E-mail: ', 'delicious'); ?><a href="mailto:<?php echo $email; ?>"><?php echo $email; ?></a></li>	
