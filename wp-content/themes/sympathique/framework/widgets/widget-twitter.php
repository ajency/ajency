 ...
 class dt_twitter_widget extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
			...
			'Sympathique - Twitter Widget',		// Name
			array(
		            ...
		            foreach($twitterData as $item){
		                    ...
		                    $link = $permalink;
		                     echo '<li class="twitter-item">';
		                      ...
		                      echo '<div class="tweet_text">'.$msg.'</div>';
		                    ...
		                    if($update) {
		                      ...
		                      echo sprintf( __('%s', 'delicious'),' <span class="tweet_time"><a href="'.$link.'"><abbr title="' . date(__('Y/m/d H:i:s', 'delicious'), $time) . '">' . $h_time . '</abbr></a></span>' );
							  echo '<a class="tweet_action tweet_reply" href="'.$tweet_reply.'">Reply</a>';
							  echo '<a class="tweet_action tweet_retweet" href="'.$retweet.'">Retweet</a>';
		                     }
