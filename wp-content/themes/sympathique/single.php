	...
	<div class="centered-wrapper">	
		<section id="blog">
			...
			<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
				...
				<div id="posts" class="single-post begin-content blog-page <?php if(isset($smof_data['blog_sidebar_pos'])) { if($smof_data['blog_sidebar_pos'] !='') { echo $smof_data['blog_sidebar_pos']; } } else echo 'sidebar-right'; ?>">
				<?php
