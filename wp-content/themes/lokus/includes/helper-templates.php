		...
		if(!empty($portfolios[0]['portfolio_page']))
		{
			...
			{	
				...
				{	
					...
					//$avia_config['portfolio_layout'] = $portfolio['portfolio_layout'];
					$avia_config['portfolio_layout'] = 'sidebar_class|zero : content_class|twelve alpha : layout|fullsize';
					$avia_config['portfolio_ajax'] = $portfolio['portfolio_ajax'];		
					$avia_config['portfolio_hover'] = $portfolio['portfolio_hover'];	
