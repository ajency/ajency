...
$elements[] =	array(	
				...
				array(	"name" 	=> "Custom Subtitle",
						"desc" 	=> "",
						"slug"  => "",
						"id"   	=> "dynamic_subtitle_custom",
						"std"  	=> "",
						"type" 	=> "text",
						"required" => array('dynamic_heading_type','custom') ),
...
$elements[] = 	array(	
				...
				'subelements' 	=> array(	
						...
						array(	
							"name" 	=> "Horizontal Ruler",
							"desc" 	=> "Adds a horizontal ruler to the template. You can choose from multiple stylings and options.",
							"id" 	=> "dynamic_hr",
							"type" 	=> "select",
							"std" 	=> "default",
							"no_first"=>true,
							"subtype" => array('Default Ruler'=>'default','Single Line'=>'default_small','Ruler with customt text'=>'custom','Invisible whitespace'=>'whitespace'),
							"slug"  => '',
							"removable"  => 'remove element'
							),
