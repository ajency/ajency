...
$this->output .= '<p><input type="submit" value="submit" class=" button contact_sumbit" /></p>';
			}
		...
		function text($id, $element)
		{
			...
			$this->elements_html .= '<div class="contact_frm_txt">'.$element['label'].':</div>';
			$this->elements_html .= ' <span><input onclick="this.value=\'\'"   name="'.$id.'" class=" text_input '.$element_class.'" type="text" id="'.$id.'"   onblur="formDefault(this)" /><label for="'.$id.'">'.$element['label'].$required.'</label></span>';
			$this->elements_html .= '<div class=" clear " ></div>';
