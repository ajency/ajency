...
global $avia_config;
	...
	{ 
		...
		$avia_config['new_query'] = array("numberposts" => $avia_config['portfolio_item_count'],  "post_type"=>"portfolio"); 
	}
	 ...
	 */	
	 get_header();
 	 if(empty($avia_config['portfolio_columns'])) $avia_config['portfolio_columns'] = 1;
