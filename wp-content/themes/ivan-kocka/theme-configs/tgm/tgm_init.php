	...
	$plugins = array(
		...
		*/
		...
		array(
			...
			'source'			 => 'http://code9rs.com/_plugins/js_composer.zip', // The plugin source.
			'required'		   => true, // If false, the plugin is only 'recommended' instead of required.
		),
		...
		array(
			...
			'source'			 => 'http://code9rs.com/_plugins/elite-addons-vc.zip', // The plugin source.
			'required'		   => true, // If false, the plugin is only 'recommended' instead of required.
		),
		...
		array(
			...
			'source'			 => 'http://code9rs.com/_plugins/mega_main_menu.zip', // The plugin source.
			'required'		   => true, // If false, the plugin is only 'recommended' instead of required.
		),
		...
		array(
			...
			'source'			 => 'http://code9rs.com/_plugins/revslider.zip', // The plugin source.
			'required'		   => true, // If false, the plugin is only 'recommended' instead of required.
		),
