 ...
 * @subpackage Importer
 */
if ( class_exists( 'WP_Importer' ) && class_exists( 'WP_Import' ) == false ) {
...
<?php
	...
	function process_categories() {
		...
		foreach ( $this->categories as $cat ) {
			...
			$id = wp_insert_term($catarr['cat_name'], "category", $catarr);
...
if( function_exists('wordpress_importer_init') == false ) {
