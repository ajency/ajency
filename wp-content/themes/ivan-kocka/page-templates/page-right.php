 ...
 *
 * The template for displaying pages with a sidebar at right
 *
...
get_header(); ?>
	...
	<div class="<?php echo apply_filters( 'iv_content_wrapper_classes', 'iv-layout content-wrapper with-sidebar content-right-sidebar ' ); ?><?php echo $_classes ?>">
		<div class="container">
