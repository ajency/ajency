...
get_header(); ?>
	...
	<div class="<?php echo apply_filters( 'iv_content_wrapper_classes', 'iv-layout content-wrapper with-sidebar content-both-right-sidebar ' ); ?><?php echo $_classes ?>">
		<div class="container">
			...
			<?php endif; ?>
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-6 col-md-6 site-main sidebar-enabled sidebar-right" role="main">
