...
// Don't duplicate me!
    if ( ! class_exists( 'ReduxFramework_button_set_mod' ) ) {

        /**
         * Main ReduxFramework_button_set_mod class
         *
         * @since       1.0.0
         */
        class ReduxFramework_button_set_mod {
            ...
            public function render() {
                ...
                echo '<div class="buttonset-mod ui-buttonset-mod">';
                $i = 0;
            ...
            public function enqueue() {
                ...
                wp_enqueue_script(
                    'redux-field-button-set-mod-js',
                    get_template_directory_uri() . '/framework/options/fields/button_set_mod/field_button_set_mod' . Redux_Functions::isMin() . '.js',
