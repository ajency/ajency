...
// Don't duplicate me!
    if ( ! class_exists( 'ReduxFramework_border_mod' ) ) {
        class ReduxFramework_border_mod {
            ...
            function enqueue() {
                ...
                wp_enqueue_script(
                    'redux-field-border-mod-js',
                    get_template_directory_uri() . '/framework/options/fields/border_mod/field_border' . $min . '.js',
                ...
                wp_enqueue_style(
                    'redux-field-border-mod-css',
                    get_template_directory_uri() . '/framework/options/fields/border_mod/field_border.css',
                    time(),
                    true
                );
            } //function
            ...
            public function output() {
                if ( isset( $this->field['all'] ) && true == $this->field['all'] ) {
                    $borderWidth = isset( $this->value['border-width'] ) ? $this->value['border-width'] : '';
                ...
                if ( ! isset( $this->field['all'] ) || $this->field['all'] != true ) {
                    foreach ( $cleanValue as $key => $value ) {
                        ...
                        if( $value != '' ) {
                        	$style .= 'border-' . $key . '-width:' . $value . ';';
                        }
                        if( $cleanValue['color'] != '' ) {
                        	$style .= 'border-' . $key . '-color:' . $cleanValue['color'] . ';';
                        }
                    }
                } else {
