...
class Ivan_Layout_Title_Wrapper_Large extends Ivan_Layout {
	...
	public function display() {
		...
		get_template_part( 'framework/templates/title_wrapper/part', apply_filters('ivan_title_wrapper_get_template', 'large') );
