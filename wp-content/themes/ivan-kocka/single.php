...
get_header(); ?>
	...
	<div class="<?php echo apply_filters( 'iv_content_wrapper_classes', 'iv-layout content-wrapper single-post', 'single' ); ?> single-<?php echo $_layout . ' style-' . $_sub_layout; ?><?php echo $_classes ?>">
		<div class="container">
