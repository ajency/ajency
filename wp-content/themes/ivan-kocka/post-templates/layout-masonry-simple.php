...
<div class="<?php echo $containerCols; ?> site-main" role="main">
	...
	?>
		...
		<?php endif; ?>
			...
			?>
				<div class="col-xs-12 col-sm-<?php echo $ivan_local_col_sm; ?> col-md-<?php echo $ivan_local_col; ?> post-wrapper<?php echo $class; ?>">
				<?php
