...
get_header(); ?>
	...
	<div class="<?php echo apply_filters( 'iv_content_wrapper_classes', 'iv-layout content-wrapper index ', 'blog' ); ?> blog-<?php echo $_layout . ' style-' . $_sub_layout; ?><?php echo $_classes ?>">
		<div class="container">
			<?php
			// Boxed Page Logic
