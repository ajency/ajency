...
class Ivan_Main_Layout_Aside_Right extends Ivan_Main_Layout {

	// Main Layout slug used as parameters to actions and filters
	public $slug = 'aside_right';
	...
	public function header_section() {
		...
		echo '<div class="ivan-main-layout-aside aside-header-wrapper ivan-main-layout-aside-right">';
		do_action( 'ivan_header' );
		echo '</div>';
		//do_action( 'ivan_fixed_header' );
		echo '<div class="ivan-main-layout-aside-left">';
	...
	public function footer_section() {
		...
		echo '</div><!-- .ivan-main-layout-aside-left --><div style="clear: both;"></div></div><!-- .ivan-aside-container -->';
	}
	...
	public function add_body_classes( $classes ) {
		...
		$classes[] = 'ivan-m-l-aside ivan-m-l-aside-right';
