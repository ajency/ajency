...
(function( $ ) {
    ...
    redux.field_objects.border_mod = redux.field_objects.border_mod || {};
    ...
    redux.field_objects.border_mod.init = function( selector ) {
        if ( !selector ) {
            selector = $( document ).find( '.redux-container-border_mod' );
        }
        ...
        $( selector ).each(
            function() {
                ...
                var select2_handle = el.find( '.redux-container-border_mod' ).find( '.select2_params' );
