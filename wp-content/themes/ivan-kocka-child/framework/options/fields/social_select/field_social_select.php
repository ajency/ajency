...
*/					
					echo '<li><a href="javascript:void(0);" class="button deletion redux-social-select-remove">' . __('Delete', 'redux-framework') . '</a></li>';
...
*/
			...
			echo '</div><a href="javascript:void(0);" class="button redux-social-select-add button-primary" rel-id="' . $this->field['id'] . '-ul" rel-name="' . $this->field['name'] . '[title][]">' . __('Add', 'redux-framework') . '</a><br/>';
