...
(function( $ ) {
    ...
    redux.field_objects.spacing_mod = redux.field_objects.spacing_mod || {};
    ...
    redux.field_objects.spacing_mod.init = function( selector ) {

        if ( !selector ) {
            selector = $( document ).find( '.redux-container-spacing_mod' );
        }
