...
// Exit if accessed directly
    ...
    if ( ! class_exists( 'ReduxFramework_spacing_mod' ) ) {
        class ReduxFramework_spacing_mod {
...
//            }
            ...
            function enqueue() {
                ...
                wp_enqueue_script(
                    'redux-field-spacing-mod-js',
                    get_template_directory_uri() . '/framework/options/fields/spacing_mod/field_spacing_mod.js',
                ...
                wp_enqueue_style(
                    'redux-field-spacing-mod-css',
                    get_template_directory_uri() . '/framework/options/fields/spacing_mod/field_spacing_mod.css',
                    time(),
                    true
                );
