...
$this->sections[] = array(
	...
	'fields' => array(
		...
		array(
			...
			'subtitle'=> __('If on and avaliable in the layout, the menu will be placed at left.', 'ivan_domain_redux'),
			'default' => 0,
			'required' => array(
		...
		array(
			...
			array(
				'id'=>'header-wpml-currency-switch',
				'type' => 'switch', 
