...
class Ivan_Layout_Header_Simple_Logo_Centered extends Ivan_Layout  {

	// Layout slug used as parameters to actions and filters
	public $slug = '_simple_logo_centered';

	public function return_template_path() {
		return 'simple-logo-centered';
	}
	...
	public function display() {
		...
		get_template_part( 'framework/templates/header/part', apply_filters('ivan_header_get_template', 'simple-logo-centered') );
