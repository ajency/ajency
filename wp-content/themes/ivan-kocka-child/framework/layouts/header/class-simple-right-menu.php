...
class Ivan_Layout_Header_Simple_Right_Menu extends Ivan_Layout  {

	// Layout slug used as parameters to actions and filters
	public $slug = '_simple_right_menu';

	public function return_template_path() {
		return 'simple-right-menu';
	}
	...
	public function display() {
		...
		get_template_part( 'framework/templates/header/part', apply_filters('ivan_header_get_template', 'simple-right-menu') );
