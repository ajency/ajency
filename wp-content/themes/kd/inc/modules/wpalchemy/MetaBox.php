...
/**
	 ...
	 */
	if (!function_exists('prk_alc_global_head'))
	{
	 ...
	 */
	if (!function_exists('prk_alc_global_foot'))
	{
...
/**
	 ...
	 * @return	int post ID
	 */
	if (!function_exists('prk_alc_get_post_id'))
	{
...
/**
	 ...
	 */
	if (!function_exists('prk_alc_get_current_post_type'))
	{
	 ...
	 */
	if (!function_exists('prk_alc_is_post_or_page'))
	{
	 ...
	 * @see		prk_alc_is_page()
	 */
	if (!function_exists('prk_alc_is_post'))
	{
	 ...
	 * @see		prk_alc_is_post()
	 */
	if (!function_exists('prk_alc_is_page'))
	{
