...
function samba_widgets_init() {
    register_sidebar(array(
        'name' => __('Right Sidebar', 'samba_lang'),
        'id' => 'sidebar-primary',
    ...
    register_sidebar(array(
        'name' => __('Left Sidebar', 'samba_lang'),
        'id' => 'sidebar-footer',
        ...
        'before_title' => '<div class="prk_titlify_father"><div class="widget-title">',
        'after_title' => '</div><div class="clearfix"></div></div>',
    ));
    //PLACE WOOCOMMERCE IF NEEDED
        include_once( ABSPATH . 'wp-admin/includes/plugin.php' );
        if (is_plugin_active('woocommerce/woocommerce.php')) {
            register_sidebar(array(
            'name' => __('WooCommerce Sidebar', 'samba_lang'),
            'id' => 'prk-woo-sidebar',
            'before_widget' => '<div id="%1$s" class="widget %2$s vertical_widget"><div class="widget-inner">',
            'after_widget' => '</div></div><div class="clearfix"></div>',
            'before_title' => '<div class="prk_titlify_father"><div class="widget-title bd_headings_text_shadow zero_color">',
...
add_action('widgets_init', 'samba_widgets_init');
