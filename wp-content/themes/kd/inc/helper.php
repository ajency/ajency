...
//FONTS
    ...
    function samba_scripts() 
    {
        ...
        wp_enqueue_style('samba_custom_style', get_template_directory_uri() . '/css/main.css', false, $prk_theme->Version);
        if (is_child_theme())
        {
        ...
        wp_register_script('samba_main', get_template_directory_uri() . '/js/main-min.js', array('jquery'), $prk_theme->Version, true);
        wp_enqueue_script('samba_main');
        wp_register_script('samba_other', get_template_directory_uri() . '/js/other-min.js', array('jquery'), $prk_theme->Version, true);
        ...
        if (PRK_WOO=="true") {
            ...
            if (isset($prk_samba_frontend_options['woo_cart_display']) && $prk_samba_frontend_options['woo_cart_display']=="cart") 
            {
        ...
        if (!isset($prk_samba_frontend_options['carousel_background_color']))
            $prk_samba_frontend_options['carousel_background_color']="#000000";
        if (!isset($prk_samba_frontend_options['carousel_background_opacity']))
            $prk_samba_frontend_options['carousel_background_opacity']="90";
        wp_localize_script('samba_main', 'theme_options', array(
            ...
            'lines_color' => $prk_samba_frontend_options['lines_color'],
            ...
            'share_text' => $prk_translations['share_text'],
            ...
            'carousel_background_opacity' => $prk_samba_frontend_options['carousel_background_opacity'],
        ...
        if (!isset($options['carousel_background_opacity']))
            $options['carousel_background_opacity']="90";
        ...
        $custom_opacity_carousel=floatval($options['carousel_background_opacity']/100);
        ...
        $splitted_carousel_background_color = html2rgb($options['carousel_background_color'],'1');
        if ($submenu_color!="")
        {
        ...
        $css .= ".sf-menu li a,
                ...
                .as-panel .grid_single_title a {
                    color: ".$options['carousel_text_color'].";
                }
                .accordion-slider .as-pagination-button {
                    border:2px solid ".$options['carousel_nav_color'].";
                }
                .accordion-slider .as-pagination-buttons .as-selected {
                    background-color:".$options['carousel_nav_color'].";
                }
                #folio_carousel.samba_opener .accordion-slider .as-layer.as-black,
                #folio_carousel.samba_opener .as-panel .titled_block {
                    background-color:".$options['carousel_background_color'].";
                ...
                if (PRK_WOO=="true") 
                {
                    $css .= ".woocommerce ul.cart_list li del, 
        ...
        wp_add_inline_style( 'samba_custom_style', $css );
    }
    ...
    function samba_setup() {
        //ADD THE DEFAULT LOCATIONS IF NECESSARY
          register_nav_menus(array(
            'top_right_navigation' => __('Main Navigation', 'samba_lang')));
    ...
    function prk_samba_header() {
        ...
        if (!isset($prk_translations['prev_prj_text'])) {
            $prk_translations['prev_prj_text']="Previous Project";
        }
        if (!isset($prk_translations['next_prj_text'])) {
            $prk_translations['next_prj_text']="Next Project";
        }
        //TRANSLATE ACCORDING TO THE SELECTED METHOD
        if ($prk_samba_frontend_options['theme_translation']=="yes" || PRK_WPML=="true")
        {
            ...
            $prk_translations['next_prj_text']=__("Next Project", 'samba_lang');
            $prk_translations['prev_prj_text']=__("Previous Project", 'samba_lang');
            ...
            $prk_translations['comments_author_text']=__("Name", 'samba_lang');
            $prk_translations['comments_email_text']=__("Email", 'samba_lang');
            $prk_translations['comments_url_text']=__("Website", 'samba_lang');
            $prk_translations['comments_comment_text']=__("Your comment here", 'samba_lang');
            ...
            $prk_translations['contact_message_text']=__("Your Message here", 'samba_lang');
    ...
    function prk_output_logo($retina_device) 
    {
        ...
        if ($retina_device=="prk_retina" && isset($prk_samba_frontend_options['logo_retina']) && $prk_samba_frontend_options['logo_retina']!="") 
        {
            ...
            $out_logo='<img src="'.$prk_samba_frontend_options['logo_retina'].'" alt="'.prk_get_img_alt($prk_samba_frontend_options['logo_retina']).'" '.$logo_dims.' class="prk_logo_image" />';
        }
        else
        {
            $logo_dims=prk_dims($prk_samba_frontend_options['logo'],1);
            $out_logo='<img src="'.$prk_samba_frontend_options['logo'] .'" alt="'.prk_get_img_alt($prk_samba_frontend_options['logo']).'" '.$logo_dims.' class="prk_logo_image" />';
        }
        return $out_logo;
    }
    function prk_output_alt_logo($retina_device) 
    {
        ...
        if ($retina_device=="prk_retina" && isset($prk_samba_frontend_options['alt_logo_retina']) && $prk_samba_frontend_options['alt_logo_retina']!="") 
        {
            ...
            $out_logo='<img id="prk_alt_logo_image" alt="'.prk_get_img_alt($prk_samba_frontend_options['alt_logo_retina']).'" src="'.$prk_samba_frontend_options['alt_logo_retina'].'" '.$alt_logo_dims.' />';
            return $out_logo;
        }
        else
        {
            if (isset($prk_samba_frontend_options['alt_logo']) && $prk_samba_frontend_options['alt_logo']!="") {
                ...
                $out_logo='<img id="prk_alt_logo_image" alt="'.prk_get_img_alt($prk_samba_frontend_options['alt_logo']).'" src="'.$prk_samba_frontend_options['alt_logo'].'" '.$alt_logo_dims.' />';
                return $out_logo;
            }
            else
            {
    ...
    function prk_output_small_logo($retina_device) 
    {
        ...
        if ($retina_device=="prk_retina" && isset($prk_samba_frontend_options['logo_retina']) && $prk_samba_frontend_options['logo_retina']!="") 
        {
            ...
            if(isset($prk_samba_frontend_options['small_logo_retina']) && $prk_samba_frontend_options['small_logo_retina']!="") 
            {
                ...
                $out_logo='<img src="'.$prk_samba_frontend_options['small_logo_retina'].'" alt="'.prk_get_img_alt($prk_samba_frontend_options['small_logo_retina']).'" '.$logo_dims.' class="prk_small_logo_image" />';
            }
            else 
            {
                if(isset($prk_samba_frontend_options['small_logo']) && $prk_samba_frontend_options['small_logo']!="") 
                {
                    $logo_dims=prk_dims($prk_samba_frontend_options['small_logo'],1);
                    $out_logo='<img src="'.$prk_samba_frontend_options['small_logo'].'" alt="'.prk_get_img_alt($prk_samba_frontend_options['small_logo']).'" '.$logo_dims.' class="prk_small_logo_image" />';
                }
                else 
                {
                    $out_logo='<img src="'.$prk_samba_frontend_options['logo_retina'].'" alt="'.prk_get_img_alt($prk_samba_frontend_options['logo_retina']).'" '.$logo_dims.' class="prk_small_logo_image" />';
                }
            }
        }
        else
        {
            ...
            {
                $out_logo='<img src="'.$prk_samba_frontend_options['logo'].'" alt="'.prk_get_img_alt($prk_samba_frontend_options['logo']).'" '.$logo_dims.' class="prk_small_logo_image" />';
            }
        }
        return $out_logo;
    }
    ...
    function prk_get_parent_portfolio() 
    {
        ...
        $pages_blog = get_pages(array(
            'meta_key' => '_wp_page_template',
            'meta_value' => 'template_portfolio_accordion.php',
            'hierarchical' => 0
        )); 
        foreach($pages_blog as $page_blog)
        {
    ...
    function prk_output_title($data)
    {
        ...
        $align_styled="";
        if (isset($data['alchemy_header_align']) && $data['alchemy_header_align']!="") {
            $align_styled=$data['alchemy_header_align'].' ';
        }
