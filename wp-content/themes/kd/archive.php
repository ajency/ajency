...
?>
        ...
        <div id="content">
            ...
            <?php 
               ...
               $cat = get_category( get_query_var( 'cat' ) );
                        ...
                        $curauth = get_query_var('author') ? get_query_var('author'): "";
                            ...
                            <div class="blog_top_image boxed_shadow">
                              <div class="blog_fader_grid">
                                ...
                                <?php 
                                    ...
                                    ?>
                                  <img src="<?php echo $vt_image['url']; ?>" width="<?php echo $vt_image['width']; ?>" height="<?php echo $vt_image['height']; ?>" id="home_fader-<?php the_ID(); ?>" class="custom-img grid_image boxed_shadow" alt="<?php echo prk_get_img_alt($image[0]); ?>" />
    ...
    if ($prk_samba_frontend_options['archives_type']=="masonry")
    {
       ...
       <div id="main_block" class="row ms_blog<?php if ($show_sidebar==true) {echo " big_main_sided";} ?>">
    <?php
        $extra_space="";
        if ($show_title==true)
        {
                                        ...
                                        <div class="entry_title entry_title_single">
                                            ...
                                            <div class="on_colored entry_content">
                                              <div class="masonr_text prk_break_word">
                                                <?php echo the_excerpt_dynamic(30); ?>
                                              </div>
                                              <div class="clearfix"></div>
