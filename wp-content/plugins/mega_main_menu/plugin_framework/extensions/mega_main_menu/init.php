 ...
 */
	if ( is_admin() ) {
		...
		*/
		//if ( ( is_array( $mega_menu_locations ) && in_array( $current_menu_location, $mega_menu_locations ) ) || ( is_array( mmpm_get_option( 'indefinite_location_mode' ) ) && in_array( 'true', mmpm_get_option( 'indefinite_location_mode' ) ) ) ) {
