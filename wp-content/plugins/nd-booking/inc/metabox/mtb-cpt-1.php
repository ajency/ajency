...
function nd_booking_meta_box()
{
    ...
    //payment options
    $nd_booking_meta_box_payment_bank = get_post_meta( get_the_ID(), 'nd_booking_meta_box_payment_bank', true );
    $nd_booking_meta_box_payment_arrive = get_post_meta( get_the_ID(), 'nd_booking_meta_box_payment_arrive', true );
    $nd_booking_meta_box_payment_request = get_post_meta( get_the_ID(), 'nd_booking_meta_box_payment_request', true );
    $nd_booking_meta_box_payment_paypal = get_post_meta( get_the_ID(), 'nd_booking_meta_box_payment_paypal', true );
    $nd_booking_meta_box_payment_stripe = get_post_meta( get_the_ID(), 'nd_booking_meta_box_payment_stripe', true );
    $nd_booking_meta_box_deposit_value = get_post_meta( get_the_ID(), 'nd_booking_meta_box_deposit_value', true );
    ...
    <div id="nd_booking_id_metabox_cpt">
        <ul>
            ...
            <li class="nd_booking_display_none"><a href="#nd_booking_tab_payment"><span class="dashicons-before dashicons-cart nd_booking_line_height_20 nd_booking_margin_right_10 nd_booking_color_444444"></span><?php _e('Payment Options','nd-booking'); ?></a></li>
        ...
        <div class="nd_booking_id_metabox_cpt_content">
            ...
            <div class="nd_booking_display_none" id="nd_booking_tab_payment">
                
                <div class="nd_booking_section nd_booking_border_bottom_1_solid_eee  nd_booking_padding_10 nd_booking_padding_left_0 nd_booking_padding_right_0 nd_booking_box_sizing_border_box">

                    <div class="nd_booking_section  nd_booking_padding_10 nd_booking_padding_top_0 nd_booking_padding_bottom_0 nd_booking_box_sizing_border_box">
                        <p class="nd_booking_margin_bottom_0"><strong><?php _e('Payment','nd-booking'); ?></strong></p>
                    </div>

                    <div class="nd_booking_float_left nd_booking_width_20_percentage  nd_booking_padding_10 nd_booking_padding_top_0 nd_booking_box_sizing_border_box">
                        <p>

                          <select class="nd_booking_width_100_percentage" name="nd_booking_meta_box_payment_bank" id="nd_booking_meta_box_payment_bank">
        
                            <option <?php if( $nd_booking_meta_box_payment_bank == 'nd_booking_default' ) { echo 'selected="selected"'; } ?> value="nd_booking_default"><?php _e('Default','nd-booking'); ?></option>
                            <option <?php if( $nd_booking_meta_box_payment_bank == 'nd_booking_yes' ) { echo 'selected="selected"'; } ?> value="nd_booking_yes"><?php _e('Yes','nd-booking'); ?></option>
                            <option <?php if( $nd_booking_meta_box_payment_bank == 'nd_booking_not' ) { echo 'selected="selected"'; } ?> value="nd_booking_not"><?php _e('Not','nd-booking'); ?></option>
                             
                          </select>

                        </p>
                        <p><?php _e('Bank Transfer','nd-booking'); ?></p>
                    </div>
                    <div class="nd_booking_float_left nd_booking_width_20_percentage  nd_booking_padding_10 nd_booking_padding_top_0 nd_booking_box_sizing_border_box">
                        <p>
                          <select class="nd_booking_width_100_percentage" name="nd_booking_meta_box_payment_arrive" id="nd_booking_meta_box_payment_arrive">
        
                            <option <?php if( $nd_booking_meta_box_payment_arrive == 'nd_booking_default' ) { echo 'selected="selected"'; } ?> value="nd_booking_default"><?php _e('Default','nd-booking'); ?></option>
                            <option <?php if( $nd_booking_meta_box_payment_arrive == 'nd_booking_yes' ) { echo 'selected="selected"'; } ?> value="nd_booking_yes"><?php _e('Yes','nd-booking'); ?></option>
                            <option <?php if( $nd_booking_meta_box_payment_arrive == 'nd_booking_not' ) { echo 'selected="selected"'; } ?> value="nd_booking_not"><?php _e('Not','nd-booking'); ?></option>
                             
                          </select>
                        </p>
                        <p><?php _e('Payment on Arrive','nd-booking'); ?></p>
                    </div>
                    <div class="nd_booking_float_left nd_booking_width_20_percentage  nd_booking_padding_10 nd_booking_padding_top_0 nd_booking_box_sizing_border_box">
                        <p>
                          <select class="nd_booking_width_100_percentage" name="nd_booking_meta_box_payment_request" id="nd_booking_meta_box_payment_request">
        
                            <option <?php if( $nd_booking_meta_box_payment_request == 'nd_booking_default' ) { echo 'selected="selected"'; } ?> value="nd_booking_default"><?php _e('Default','nd-booking'); ?></option>
                            <option <?php if( $nd_booking_meta_box_payment_request == 'nd_booking_yes' ) { echo 'selected="selected"'; } ?> value="nd_booking_yes"><?php _e('Yes','nd-booking'); ?></option>
                            <option <?php if( $nd_booking_meta_box_payment_request == 'nd_booking_not' ) { echo 'selected="selected"'; } ?> value="nd_booking_not"><?php _e('Not','nd-booking'); ?></option>
                             
                          </select>
                        </p>
                        <p><?php _e('Book Request','nd-booking'); ?></p>
                    </div>
                    <div class="nd_booking_float_left nd_booking_width_20_percentage  nd_booking_padding_10 nd_booking_padding_top_0 nd_booking_box_sizing_border_box">
                        <p>
                          <select class="nd_booking_width_100_percentage" name="nd_booking_meta_box_payment_paypal" id="nd_booking_meta_box_payment_paypal">
        
                            <option <?php if( $nd_booking_meta_box_payment_paypal == 'nd_booking_default' ) { echo 'selected="selected"'; } ?> value="nd_booking_default"><?php _e('Default','nd-booking'); ?></option>
                            <option <?php if( $nd_booking_meta_box_payment_paypal == 'nd_booking_yes' ) { echo 'selected="selected"'; } ?> value="nd_booking_yes"><?php _e('Yes','nd-booking'); ?></option>
                            <option <?php if( $nd_booking_meta_box_payment_paypal == 'nd_booking_not' ) { echo 'selected="selected"'; } ?> value="nd_booking_not"><?php _e('Not','nd-booking'); ?></option>
                             
                          </select>
                        </p>
                        <p><?php _e('PayPal','nd-booking'); ?></p>
                    </div>
                    <div class="nd_booking_float_left nd_booking_width_20_percentage  nd_booking_padding_10 nd_booking_padding_top_0 nd_booking_box_sizing_border_box">
                        <p>
                          <select class="nd_booking_width_100_percentage" name="nd_booking_meta_box_payment_stripe" id="nd_booking_meta_box_payment_stripe">
        
                            <option <?php if( $nd_booking_meta_box_payment_stripe == 'nd_booking_default' ) { echo 'selected="selected"'; } ?> value="nd_booking_default"><?php _e('Default','nd-booking'); ?></option>
                            <option <?php if( $nd_booking_meta_box_payment_stripe == 'nd_booking_yes' ) { echo 'selected="selected"'; } ?> value="nd_booking_yes"><?php _e('Yes','nd-booking'); ?></option>
                            <option <?php if( $nd_booking_meta_box_payment_stripe == 'nd_booking_not' ) { echo 'selected="selected"'; } ?> value="nd_booking_not"><?php _e('Not','nd-booking'); ?></option>
                             
                          </select>
                        </p>
                        <p><?php _e('Stripe','nd-booking'); ?></p>
                    </div>
                </div>

                <div class="nd_booking_section nd_booking_border_bottom_1_solid_eee nd_booking_padding_10 nd_booking_box_sizing_border_box">
                    <p><strong><?php _e('Deposit Value','nd-booking'); ?></strong></p>
                    <p><input class="nd_booking_width_100_percentage" type="text" name="nd_booking_meta_box_deposit_value" id="nd_booking_meta_box_deposit_value" value="<?php echo $nd_booking_meta_box_deposit_value ?>" /></p>
                    <p><?php _e('Insert description','nd-booking'); ?></p>
                </div>
            ...
            <div id="nd_booking_tab_exceptions">
                ...
                <div class="nd_booking_section nd_booking_padding_10 nd_booking_box_sizing_border_box">
                    <p><strong><?php _e('Exceptions','nd-booking'); ?></strong></p>
...
function nd_booking_meta_box_save( $post_id )
{
    ...
    //payment options
    if( isset( $_POST['nd_booking_meta_box_payment_bank'] ) ) update_post_meta( $post_id, 'nd_booking_meta_box_payment_bank', wp_kses( $_POST['nd_booking_meta_box_payment_bank'], $allowed ) );
    if( isset( $_POST['nd_booking_meta_box_payment_arrive'] ) ) update_post_meta( $post_id, 'nd_booking_meta_box_payment_arrive', wp_kses( $_POST['nd_booking_meta_box_payment_arrive'], $allowed ) );
    if( isset( $_POST['nd_booking_meta_box_payment_request'] ) ) update_post_meta( $post_id, 'nd_booking_meta_box_payment_request', wp_kses( $_POST['nd_booking_meta_box_payment_request'], $allowed ) );
    if( isset( $_POST['nd_booking_meta_box_payment_paypal'] ) ) update_post_meta( $post_id, 'nd_booking_meta_box_payment_paypal', wp_kses( $_POST['nd_booking_meta_box_payment_paypal'], $allowed ) );
    if( isset( $_POST['nd_booking_meta_box_payment_stripe'] ) ) update_post_meta( $post_id, 'nd_booking_meta_box_payment_stripe', wp_kses( $_POST['nd_booking_meta_box_payment_stripe'], $allowed ) );
    if( isset( $_POST['nd_booking_meta_box_deposit_value'] ) ) update_post_meta( $post_id, 'nd_booking_meta_box_deposit_value', wp_kses( $_POST['nd_booking_meta_box_deposit_value'], $allowed ) );
