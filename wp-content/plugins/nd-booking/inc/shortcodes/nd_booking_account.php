      ...
      $nd_booking_result .= '
        ...
        <tr class="nd_booking_border_bottom_1_solid_grey">
            ...
            <td class="nd_booking_padding_20"> 
                ...
                <p class="nd_booking_display_none_all_iphone">'.__('Transiction : ','nd-booking').''.$nd_booking_reservation_id->paypal_tx.'</p>
            </td>
            <td class="nd_booking_padding_20 nd_booking_display_none_all_iphone">
            ...
            $nd_booking_result .= '
                ...
                <form action="'.nd_booking_order_page().'" method="POST">
                    ...
                    <input class=" '.$nd_booking_order_btn_bg_color.' nd_booking_text_transform_uppercase nd_options_second_font_important nd_booking_font_weight_lighter nd_booking_letter_spacing_2 nd_booking_padding_8  nd_booking_font_size_13 " type="submit" value="'.$nd_booking_reservation_id->paypal_payment_status.'">
