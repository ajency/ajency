...
$nd_booking_shortcode_right_content .= '
    ...
    <div class="nd_booking_width_100_percentage nd_booking_float_left nd_booking_box_sizing_border_box ">
        ...
        <p>'.str_replace('_', ' ', $nd_booking_order_action_type).'</p>
    </div>

    <div class="nd_booking_section nd_booking_height_20"></div>

    <p class="nd_booking_bg_yellow nd_booking_padding_15_30_important nd_options_second_font_important nd_booking_border_radius_0_important nd_options_color_white nd_booking_display_inline_block nd_booking_font_size_11 nd_booking_font_weight_bold nd_booking_letter_spacing_2 nd_booking_text_transform_uppercase">'.$nd_booking_order_paypal_payment_status.'</p>
    ';
