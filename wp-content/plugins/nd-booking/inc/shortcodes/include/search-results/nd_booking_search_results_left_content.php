...
$nd_booking_shortcode_left_content .= '
    ...
    <form id="nd_booking_search_cpt_1_form_sidebar">
        ...
        <div id="nd_booking_search_cpt_1_form_normal_services" class=" '.$nd_booking_search_class_2.' nd_booking_width_100_percentage nd_booking_float_left nd_booking_padding_0_15 nd_booking_box_sizing_border_box">
            ...
            foreach ($nd_booking_services as $nd_booking_service) : 
                ...
                <p class="nd_booking_width_50_percentage nd_booking_width_100_percentage_all_iphone nd_booking_float_left nd_booking_margin_0">
                  <input class="nd_booking_checkbox_service nd_booking_width_25 nd_booking_margin_0 nd_booking_padding_0 nd_booking_margin_top_8" name="nd_booking_service_id_'.$nd_booking_additional_service->ID.'" type="checkbox" value="'.$nd_booking_service->ID.',">
                    '.$nd_booking_service->post_title.'
                </p>';
        ...
        <div id="nd_booking_search_cpt_1_form_extra_services" class=" '.$nd_booking_search_class_3.' nd_booking_width_100_percentage nd_booking_float_left nd_booking_padding_0_15 nd_booking_box_sizing_border_box">
            ...
            $nd_booking_additional_services = get_posts($nd_booking_additional_services_args); 
            foreach ($nd_booking_additional_services as $nd_booking_additional_service) : 

                $nd_booking_shortcode_left_content .= '
                <p class="nd_booking_width_50_percentage nd_booking_width_100_percentage_all_iphone nd_booking_float_left nd_booking_margin_0">
                  <input class="nd_booking_checkbox_additional_service nd_booking_width_25 nd_booking_margin_0 nd_booking_padding_0 nd_booking_margin_top_8" name="nd_booking_additional_service_id_'.$nd_booking_additional_service->ID.'" type="checkbox" value="'.$nd_booking_additional_service->ID.',">
                    '.$nd_booking_additional_service->post_title.'
                </p>';
