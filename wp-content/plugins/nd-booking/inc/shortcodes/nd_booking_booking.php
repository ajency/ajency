...
function nd_booking_validate_fields_php_function() {
  ...
  if ( $nd_booking_result_name == 1 AND  $nd_booking_result_surname == 1 AND $nd_booking_result_email == 1 AND $nd_booking_result_phone == 1 AND $nd_booking_result_message == 1 AND $nd_booking_result_term == 1 ){
    echo 1;
  }else{
