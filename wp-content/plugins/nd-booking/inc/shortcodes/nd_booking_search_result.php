...
function nd_booking_sorting_php() {
    ...
    for ($nd_booking_services_i = 0; $nd_booking_services_i < count($nd_booking_services_array)-1; $nd_booking_services_i++) {
        ...
        $nd_booking_add_new_service_to_meta_query = '["key" => "nd_booking_meta_box_normal_services", "value" => "'.$nd_booking_service_slug.'", "compare" => "LIKE"]';
        $args['meta_query'][$nd_booking_add_new_service_to_meta_query_position] = $nd_booking_add_new_service_to_meta_query;
    ...
    for ($nd_booking_additional_services_i = 0; $nd_booking_additional_services_i < count($nd_booking_additional_services_array)-1; $nd_booking_additional_services_i++) {
        ...
        $nd_booking_add_new_additional_service_to_meta_query = '["key" => "nd_booking_meta_box_additional_services", "value" => "'.$nd_booking_additional_service_slug.'", "compare" => "LIKE"]';
        $args['meta_query'][$nd_booking_add_new_additional_service_to_meta_query_position] = $nd_booking_add_new_additional_service_to_meta_query;
