...
if(have_posts()) :
	while(have_posts()) : the_post();
        ...
        $nd_booking_calendar .= '
        	...
        	<!--START FORM-->
			<form id="nd_booking_single_cpt_1_calendar" action="'.nd_booking_search_page().'" method="get">
							                		...
							                		while( $nd_booking_date_cicle <= $nd_booking_date_end_format ) {
							                			...
							                			if ( $nd_booking_date_i == 1 ) { 
							                				...
							                				<div class="nd_booking_width_30_percentage nd_booking_width_100_percentage_responsive nd_booking_float_left nd_booking_box_sizing_border_box '.$nd_booking_week_class.' ">
							                					...
							                					<div class="nd_booking_section">
							                						<div class="nd_booking_section"><p class="nd_booking_week_price_first_line">'.$nd_booking_week_word.' '.__('WEEK','nd-booking').'</p></div>
