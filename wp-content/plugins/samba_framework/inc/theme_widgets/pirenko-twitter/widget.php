				...
				if ( ! empty( $title ) ){ echo $before_title . $title . $after_title; }
					...
					if(!empty($tp_twitter_plugin_tweets)){
						...
						<div class="tp_recent_tweets">';
							print' <ul class="prk_twt_ul">';
							$fctr = '1';
							foreach($tp_twitter_plugin_tweets as $tweet){								
								print '<li><div class="icon-twitter prk_less_opacity"></div><div class="prk_twt_body"><div class="twt_in">'.convert_links($tweet['text']).'</div><div class="clearfix"></div><a class="twitter_time" target="_blank" href="http://twitter.com/'.$instance['username'].'/statuses/'.$tweet['status_id'].'">'.relative_time($tweet['created_at']).'</a> - <a class="twitter_time" target="_blank" href="http://twitter.com/'.$instance['username'].'">'.$instance['username'].'</a></div></li>';
