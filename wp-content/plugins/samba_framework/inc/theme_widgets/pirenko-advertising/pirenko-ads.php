	...
	*/
	...
	class pirenko_advertising_widget extends WP_Widget 
	{
		...
		function pirenko_advertising_widget() 
		{
			...
			$this->WP_Widget( 'pirenko-advertising-widget', __('Samba: Advertising Widget ', 'samba_lang'), $widget_ops, $control_ops );
		}
		...
		function widget( $args, $instance ) 
		{
			...
			{
				printf( '<a href="%s" target="_blank"><img src="%s" title="advertisement" class="fade_on_rollover adv_img" /></a>', esc_attr($instance['advert_url']), esc_attr($instance['image_path']) );
