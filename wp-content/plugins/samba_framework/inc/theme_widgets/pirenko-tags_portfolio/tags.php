	...
	*/
	...
	class pirenko_tags_portfolio_widget extends WP_Widget 
	{
		...
		function pirenko_tags_portfolio_widget() 
		{
			...
			$this->WP_Widget( 'pirenko-tags-portfolio-widget', __('Samba: Portfolio Tag Links', 'samba_lang'), $widget_ops, $control_ops );
		}
		...
		function form( $instance ) 
		{
            ...
            <p>
				<label for="<?php echo $this->get_field_id('link_type'); ?>"><?php _e('Use skills or tags?', 'samba_lang'); ?></label><br />
