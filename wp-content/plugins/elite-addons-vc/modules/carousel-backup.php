...
if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
	...
	class WPBakeryShortCode_ivan_carousel extends WPBakeryShortCodesContainer {
		...
		protected function content( $atts, $content = null ) {
			...
			$output .= '<div class="ivan-carousel '. $el_class . ' ' . $prefixClass .'"><div class="carousel-wrapper '.$class.'">';
			...
			$output .= '<script type="text/javascript">
				...
				$output .= '
				<textarea class="ivan-script">
					jQuery(document).ready(function() {

						var _this = jQuery("'.$this->prefix.' .carousel-wrapper");

						/*setTimeout(function() { '.$carouselCode.' }, 1000);*/
						// Destroy previous OwlCarousel Markup
						if(_this.find(".owl-wrapper-outer").length > 0) {
							var _originalItems = _this.find(".owl-item > div");
				...
				$output .= '
						jQuery(".preview-'. $prefixClass .' .on").click(function(e) {
							if(typeof jQuery.fn.owlCarousel == "function") {
								'.$carouselCode.'
							}
							e.preventDefault();
						...
						jQuery(".preview-'. $prefixClass .' .off").click(function(e) {
